...
Return STRICT JSON:
{"items":[{"item_number","description","quantity","unit","unit_price","total_price","scope_category":"main|optional|excluded","trade":"carpentry","sub_scope","frr","source_page":number|null,"source_section":string|null,"section_path":string[]|null,"building_or_block":string|null,"confidence":0..1}]}
