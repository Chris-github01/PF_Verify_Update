...
`;
    ...
    // Add header and footer with proper height and visibility
    // CRITICAL: Use Chromium placeholders for page numbers (NOT CSS counters)
    formData.append('headerHtml', `
      <html>
        ...
        <body>
          <div class="left">${leftHeader}</div>
          <div class="right">${today} | Page <span class="pageNumber"></span> of <span class="totalPages"></span></div>
        </body>
      </html>
    `);
    ...
    formData.append('footerHtml', `
      <html>
        ...
        <body>
          <div>Generated by VerifyTrade</div>
        </body>
      </html>
    `);
