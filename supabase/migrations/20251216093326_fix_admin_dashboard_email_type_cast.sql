/*
  # Fix Admin Dashboard - Cast Email to Text Type

  1. Changes
    - Cast auth.users.email (varchar) to text to match function return type
    - This resolves the type mismatch error in column 15

  2. Technical Details
    - auth.users.email is varchar(255)
    - Function returns text
    - Need explicit cast to match types
*/
...
BEGIN
  ...
  SELECT 
    ...
    (SELECT u.email::text FROM organisation_members om 
