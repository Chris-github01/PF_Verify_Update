/*
  # Add total_amount and avg_confidence to get_admin_quotes
  
  Updates the get_admin_quotes function to calculate and return
  total_amount and avg_confidence from quote_items.
*/
