/*
  # Fix Admin Functions with Correct Columns
  
  1. Changes
    - Fix get_admin_audit_events to use correct text type cast
    - Fix get_admin_quotes to use id instead of quote_id
    - Match all column types to actual database schema
*/

-- Fix get_admin_audit_events with correct types
...
-- Fix get_admin_quotes with correct columns
