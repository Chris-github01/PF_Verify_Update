/*
  # Fix get_admin_quotes to include file URLs from parsing_jobs
  
  Updates the get_admin_quotes function to properly join with parsing_jobs
  table to retrieve file URLs, since they are stored there rather than in
  the quotes table directly.
*/
